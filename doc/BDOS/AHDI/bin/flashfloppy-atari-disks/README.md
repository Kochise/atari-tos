...
___Update__: images for HD floppy capable machines are included in the [HD/](HD/) folder, these provide higher throughput by using a 500 kbit/sec data rate (tested on an Atari Mega STE configured for HD floppies)._
