...
"[3][Even though the display|cannot show the new mask,|it HAS been \
modified.][Ok]",
...
"[1][|There is no more room|in memory for new icons][Ok]",	/* 10 */
...
"[1][|A .NIC file with this|name already exists][Ok]",	/* 30 */
...
" 1 icon selected",
" %d icons selected",
"Desk Pattern",	/* 12 chars max */
"Select the block to cut",	/* 40 */
