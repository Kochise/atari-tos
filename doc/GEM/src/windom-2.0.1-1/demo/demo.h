...
#define MN1_AVSENDFILE   45  /* STRING dans l'arbre MENU1 */
#define MN1_AVOPENDIR    46  /* STRING dans l'arbre MENU1 */
#define MN1_AVSENDKEY    47  /* STRING dans l'arbre MENU1 */
#define MN1_AVVIEW       48  /* STRING dans l'arbre MENU1 */
#define MN1_AVSTATUS     50  /* STRING dans l'arbre MENU1 */
#define MN1_OP2          53  /* STRING dans l'arbre MENU1 */
#define MN1_READCONF     54  /* STRING dans l'arbre MENU1 */
#define MN1_CONF_WINDOM  56  /* STRING dans l'arbre MENU1 */
#define MN1_WINDOM       57  /* STRING dans l'arbre MENU1 */
#define MN1_OP3          59  /* STRING dans l'arbre MENU1 */

#define DIAL1            1   /* Formulaire/Dialogue */
#define DIAL1_COMPILER   2   /* TEXT dans l'arbre DIAL1 */
...
#define TL2_POPUP        2   /* BOXTEXT dans l'arbre TOOL2 */
#define TL2_CYCLE        3   /* BOXCHAR dans l'arbre TOOL2 */
...
#define FRAME            21  /* Formulaire/Dialogue */
#define FRAMEACK         1   /* BUTTON dans l'arbre FRAME */
#define FRAMEOK          2   /* BUTTON dans l'arbre FRAME */
