...
#define BUT_POP2         8   /* BUTTON dans l'arbre FRM1 */
#define BUT_PREF         12  /* BUTTON dans l'arbre FRM1 */
#define BUT_WINCONF      13  /* BUTTON dans l'arbre FRM1 */
#define BUT_POP3         16  /* BUTTON dans l'arbre FRM1 */
