...
#if  !defined(__ACSAES__)
#include <acesaes.h>                    /* for MFORM                    */
#endif /* __AES_H__ */
...
typedef short SSB[10 + 4 * 64];

typedef short PATTERN[16];            /* Bei Bedarf vergrîûern        */
...
typedef struct
{
    short b_wd,                     /* Breite des Blocks in Pixeln  */
