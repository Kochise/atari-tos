/*
 * GEM resource C output of edlist
 *
...
static char edlist_string_0[] = "Alt:";
static char edlist_string_1[] = "12345678901234567890";
static char edlist_string_2[] = "";
static char edlist_string_3[] = "";
static char edlist_string_4[] = "12345678901234567890";
static char edlist_string_5[] = "";
static char edlist_string_6[] = "";
static char edlist_string_7[] = "Neu:";
static char edlist_string_8[] = "Neu";
static char edlist_string_9[] = "Alt";
static char edlist_string_10[] = "Abbruch";
static char edlist_string_11[] = "1234567890123456789012345678901";
static char edlist_string_12[] = "";
static char edlist_string_13[] = "";


static TEDINFO rs_tedinfo[NUM_TI] = {
	{ edlist_string_1, edlist_string_2, edlist_string_3, IBM, 0, TE_CNTR, 0x1180, 0x0, 0, 21,1 }, /* DIFF_TYPE_OLDTYPE */
	{ edlist_string_4, edlist_string_5, edlist_string_6, IBM, 0, TE_CNTR, 0x1180, 0x0, 0, 21,1 }, /* DIFF_TYPE_NEWTYPE */
	{ edlist_string_11, edlist_string_12, edlist_string_13, IBM, 0, TE_CNTR, 0x1180, 0x0, -1, 32,1 }
};
...
/* DIFF_TYPE */
	...
	{ -1, 1, 1, G_IBOX, OF_NONE, OS_NORMAL, C_UNION(0xFF1141L), 0,0, 36,9 },
	{ 0, 2, 12, G_BOX, OF_NONE, OS_NORMAL, C_UNION(0xFF1101L), 0,0, 36,9 },
	{ 3, -1, -1, G_STRING, OF_NONE, OS_NORMAL, C_UNION(edlist_string_0), 5,3, 4,1 },
	{ 4, -1, -1, G_BOXTEXT, OF_NONE, OS_NORMAL, C_UNION(&rs_tedinfo[0]), 11,3, 20,1 }, /* DIFF_TYPE_OLDTYPE */
	{ 5, -1, -1, G_BOXTEXT, OF_NONE, OS_NORMAL, C_UNION(&rs_tedinfo[1]), 11,4, 20,1 }, /* DIFF_TYPE_NEWTYPE */
	{ 6, -1, -1, G_STRING, OF_NONE, OS_NORMAL, C_UNION(edlist_string_7), 5,4, 4,1 },
	{ 8, 7, 7, G_BUTTON, OF_SELECTABLE, OS_NORMAL, C_UNION(edlist_string_8), 1,6, 10,2 }, /* DIFF_TYPE_NEW */
	{ 6, -1, -1, G_IBOX, OF_NONE, OS_NORMAL, C_UNION(0x1100L), 0,1, 2,1 },
	{ 10, 9, 9, G_BUTTON, OF_SELECTABLE, OS_NORMAL, C_UNION(edlist_string_9), 13,6, 10,2 }, /* DIFF_TYPE_OLD */
	{ 8, -1, -1, G_IBOX, OF_NONE, OS_NORMAL, C_UNION(0x1100L), 0,1, 2,1 },
	{ 12, 11, 11, G_BUTTON, OF_SELECTABLE, OS_NORMAL, C_UNION(edlist_string_10), 25,6, 10,2 }, /* DIFF_TYPE_CANCEL */
	{ 10, -1, -1, G_IBOX, OF_NONE, OS_NORMAL, C_UNION(0x1100L), 0,1, 2,1 },
	{ 1, -1, -1, G_BOXTEXT, OF_LASTOB, OS_NORMAL, C_UNION(&rs_tedinfo[2]), 2,1, 32,1 }
};


static OBJECT *rs_trindex[NUM_TREE] = {
	&rs_object[0] /* DIFF_TYPE */
};
...
#ifdef __STDC__
_WORD edlist_rsc_load(_WORD wchar, _WORD hchar)
#else
_WORD edlist_rsc_load(wchar, hchar)
_WORD wchar;
_WORD wchar;
#endif
{
...
#ifdef __STDC__
_WORD edlist_rsc_gaddr(_WORD type, _WORD idx, void *gaddr)
#else
_WORD edlist_rsc_gaddr(type, idx, gaddr)
_WORD type;
_WORD idx;
void *gaddr;
#endif
...
#ifdef __STDC__
_WORD edlist_rsc_free(void)
#else
_WORD edlist_rsc_free()
#endif
{
#if NUM_OBS != 0
