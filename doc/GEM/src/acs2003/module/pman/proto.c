...
static AUSERBLK230 vslider = { A_wislider, 1L, Auo_wislider, NULL, NULL, NULL };
static AUSERBLK230 hslider = { A_wislider, 0L, Auo_wislider, NULL, NULL, NULL };
...
static Awindow *proto_make(void *para)
{
	...
	if ((self = Awi_create((Awindow *)&PROTOCOL)) == NULL)
		return NULL;
