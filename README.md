...
Even more recent **Atari** clones like the [Firebee] or **Vampire** [V4SA] can't really keep up with "modern" needs (so still no **Firefox**, no **Blender**, no **Libre Office**, etc). Just running "legacy" **TOS** applications, if compatibility layers permit it, yet notably faster. But nothing "ground-breaking" (or "earth-shattering"), it's still way from being **Ryzen**-tier capable hardware.
...
* TOS: The Operating System
	...
	* BDOS: Basic Disk Operating System
		...
		* LINEA: low-level graphic routines
	...
	* OTHER: software extensions and protocols
		...
		* STING: TCP/IP stack
		* LDG: loadable dependencies manager
		* AV: IPC protocol between applications
		* OLGA: object linking protocol
		* DRAG: Drag and Drop protocol
		* BGEM: tooltip support
		* SCRIPT: automation and scripting
...
flowchart TD
	...
	click HAL "https://github.com/Kochise/atari-tos/tree/master/doc/HAL" _blank
	click CPU "https://github.com/Kochise/atari-docs/tree/master/CPU68030/DOCS" _blank
	click BLITTER "https://github.com/Kochise/atari-docs/tree/master/BLITTER" _blank
	click IO "https://github.com/Kochise/atari-docs/tree/master/IOPORTS/DOCS" _blank

	click OTHER "https://github.com/Kochise/atari-tos/tree/master/doc/OTHER" _blank
	click XBRA "https://github.com/Kochise/atari-tos/tree/master/doc/OTHER/XBRA" _blank
	click JAR "https://github.com/Kochise/atari-tos/tree/master/doc/OTHER/JAR" _blank
	click STING "https://github.com/Kochise/atari-tos/tree/master/doc/OTHER/STING" _blank
	click LDG "https://github.com/Kochise/atari-tos/tree/master/doc/OTHER/LDG" _blank
	click AV "https://github.com/Kochise/atari-tos/tree/master/doc/OTHER/AV" _blank
	click OLGA "https://github.com/Kochise/atari-tos/tree/master/doc/OTHER/OLGA" _blank
	click DRAG "https://github.com/Kochise/atari-tos/tree/master/doc/OTHER/DRAG" _blank
	click BGEM "https://github.com/Kochise/atari-tos/tree/master/doc/OTHER/BGEM" _blank
	click SCRIPT "https://github.com/Kochise/atari-tos/tree/master/doc/OTHER/SCRIPT" _blank

	click BDOS "https://github.com/Kochise/atari-tos/tree/master/doc/BDOS" _blank
	click BIOS "https://github.com/Kochise/atari-tos/tree/master/doc/BDOS/BIOS" _blank
	click XBIOS "https://github.com/Kochise/atari-tos/tree/master/doc/BDOS/XBIOS" _blank
	...
	click VDI "https://github.com/Kochise/atari-tos/tree/master/doc/GEM/VDI" _blank
	click GDOS "https://github.com/Kochise/atari-tos/tree/master/doc/GEM/GDOS" _blank

	click VD "https://github.com/Kochise/atari-tos/tree/master/doc/VD" _blank
	click SCREEN "https://github.com/Kochise/atari-tos/tree/master/doc/VD/SCREEN" _blank
	click PRINTER "https://github.com/Kochise/atari-tos/tree/master/doc/VD/PRINTER" _blank
...
| Size			| Assembler		| C (16 bits)		| C99		| GEM		| GFA v3				| Omikron			|
| :---			| :---			| :---				| :---		| :---		| :---					| :---				|
| 1 bit			| 				| 					| bool		| 			| ! (16 bits)			| %F				|
| 8 bits		| .b			| char				| int8_t	| BYTE		| \| - BYTE()			| %B				|
| 16 bits		| .w			| int :warning:		| int16_t	| WORD		| & - CARD()			| %W or %			|
| 32 bits		| .l			| long  :warning:	| int32_t	| LONG		| % 					| %L or no suffix	|
| [float]		| .f (32 bits)	| float				| float		| 			| 						| ! (6 bytes)		|
| [double]		| .d (64 bits)	| double			| double	| 			| # or no suffix[^2]	| 					|
